/**
 * Minimal SVG icons. Each uses `currentColor` and inherits sizing from its
 * parent (`w-5 h-5` etc.).
 */
...
export function SparklesIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M19 15l1 2.5L22.5 19l-2.5 1L19 22.5l-1-2.5L15.5 19l2.5-1L19 15z" />
      <path d="M5 17l.5 1 1 .5-1 .5-.5 1-.5-1-1-.5 1-.5.5-1z" />
    </svg>
  );
}
